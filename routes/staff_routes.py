...
def od_details(request_id):
    ...
    try:
        ...
        if od_request:
            ...
            student_id = od_request.get('student_id')
            ...
            # Attach student details to cleaned request
            if student:
                cleaned_request['student_name'] = student.get('name', 'N/A')
                cleaned_request['class'] = student.get('class', 'N/A')
                cleaned_request['contact'] = str(student.get('phone', 'N/A'))
            else:
                cleaned_request['student_name'] = 'N/A'
                cleaned_request['class'] = 'N/A'
                cleaned_request['contact'] = 'N/A'
